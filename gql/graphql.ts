...
export type GetAllTweetsQuery = { getAllTweets: Array<{ id: string, content: string, imageURL: string | null, author: { firstName: string, lastName: string | null, profileImageUrl: string | null } | null } | null> | null };
...
export type GetCurrentUserQuery = { getCurrentUser: { id: string, profileImageUrl: string | null, email: string, firstName: string, lastName: string | null, tweets: Array<{ id: string, content: string, imageURL: string | null, author: { firstName: string, lastName: string | null, profileImageUrl: string | null } | null } | null> | null } | null };

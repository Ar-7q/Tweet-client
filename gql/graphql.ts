...
export type GetUserByIdQuery = { getUserById: { id: string, firstName: string, lastName: string | null, profileImageUrl: string | null, followers: Array<{ id: string, follower: { id: string } | null } | null> | null, following: Array<{ id: string, following: { id: string } | null } | null> | null, tweets: Array<{ content: string, id: string, imageURL: string | null, createdAt: string | null, imagePublicId: string | null, likesCount: number | null, comments: Array<{ id: string, content: string, createdAt: string, author: { id: string, firstName: string, lastName: string | null, profileImageUrl: string | null } } | null> | null, author: { id: string, firstName: string, lastName: string | null, profileImageUrl: string | null } | null } | null> | null } | null };

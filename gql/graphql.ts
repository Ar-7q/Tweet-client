...
export type GetAllTweetsQuery = { getAllTweets: Array<{ id: string, content: string, imageURL: string | null, createdAt: string | null, imagePublicId: string | null, likesCount: number | null, author: { id: string, firstName: string, lastName: string | null, profileImageUrl: string | null } | null } | null> | null };
...
export type GetUserByIdQuery = { getUserById: { id: string, firstName: string, lastName: string | null, profileImageUrl: string | null, tweets: Array<{ content: string, id: string, imageURL: string | null, createdAt: string | null, imagePublicId: string | null, author: { id: string, firstName: string, lastName: string | null, profileImageUrl: string | null } | null } | null> | null } | null };
